...
import com.example.whatsappclone.data.COLLECTION_CHAT
import com.example.whatsappclone.data.COLLECTION_MESSAGES
import com.example.whatsappclone.data.COLLECTION_STATUS
...
class AppViewModel @Inject constructor(
    ...
    val chatMessages = mutableStateOf<List<Notification.MessagingStyle.Message>>(listOf())
    val inProgressChatMessages = mutableStateOf(false)
    var currentChatMessagesListener: ListenerRegistration? = null

    val status = mutableStateOf<List<UrlRequest.Status>>(listOf())
